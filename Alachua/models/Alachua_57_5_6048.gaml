...
species people skills: [moving]{
	...
	reflex stay_at_home_assign when: cycle=6048 and sah_complete=false{
		ask int(0.575*nb_people) among people{
			stay_at_home<-true;
...
experiment '100 times' type:batch repeat: 100 until: cycle>12101 parallel: 8 {
	reflex end_of_runs{
		...
		save[comp_hundred_list] to: "results_Alachua_57_5_6048_100.csv" type:csv rewrite: false;
	}
}	