...
species people skills: [moving]{
	...
	reflex mask_assign_1 when: cycle=2160 and ma_1_complete=false{
	...
	reflex mask_assign_2 when: cycle=2304 and ma_2_complete=false{
		ask int((0.3/7)*nb_people) among (people where (masked=false)){
			masked<-true;
			w_infect_param<-(1-0.7)*(w_infect_param);
			w_infectee_param<-(1-0.7)*(w_infectee_param);
	...
	reflex mask_assign_3 when: cycle=2448 and ma_3_complete=false{
		ask int((0.3/7)*nb_people) among (people where (masked=false)){
			masked<-true;
			w_infect_param<-(1-0.7)*(w_infect_param);
			w_infectee_param<-(1-0.7)*(w_infectee_param);
	...
	reflex mask_assign_4 when: cycle=2592 and ma_4_complete=false{
		ask int((0.3/7)*nb_people) among (people where (masked=false)){
			masked<-true;
			w_infect_param<-(1-0.7)*(w_infect_param);
			w_infectee_param<-(1-0.7)*(w_infectee_param);
	...
	reflex mask_assign_5 when: cycle=2736 and ma_5_complete=false{
		ask int((0.3/7)*nb_people) among (people where (masked=false)){
			masked<-true;
			w_infect_param<-(1-0.7)*(w_infect_param);
			w_infectee_param<-(1-0.7)*(w_infectee_param);
	...
	reflex mask_assign_6 when: cycle=2880 and ma_6_complete=false{
		ask int((0.3/7)*nb_people) among (people where (masked=false)){
			masked<-true;
			w_infect_param<-(1-0.7)*(w_infect_param);
			w_infectee_param<-(1-0.7)*(w_infectee_param);
	...
	reflex mask_assign_7 when: cycle=3024 and ma_7_complete=false{
		ask int((0.3/7)*nb_people) among (people where (masked=false)){
			masked<-true;
			w_infect_param<-(1-0.7)*(w_infect_param);
			w_infectee_param<-(1-0.7)*(w_infectee_param);
...
experiment '100 times' type:batch repeat: 100 until: cycle>12101 parallel: 8 {
	...
	reflex end_of_runs{
		...
		save[comp_hundred_list] to: "results_Alachua_mask_3024_100.csv" type:csv rewrite: false;
	}
}	